...
import { fetchAdmin, fetchAdminWithMeta, createAdmin, replaceAdmin, editAdmin, deleteAdmin, login } from "./handlers/index.js";
 ...
 * - `POST /api/v1/auth/login` — authenticate an admin and return a session token.
 *
