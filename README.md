...
Refer to the **[Contributing Guide](DOCS/CONTRIBUTING.md)** for full setup instructions, including how to run the application locally and contribute to the project.
